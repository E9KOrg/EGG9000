...
namespace EGG9000.Bot.EggIncAPI {
    ...
    public class ContractsAPI {
        ...
        public static readonly List<(string EggIncId, Ei.Contract.Types.PlayerGrade Grade, string Name)> CreatorIds = new() {
        ...
        public static string GetHash(byte[] byteArray) {
            ...
            var _salt = Encoding.ASCII.GetBytes(ByteArrayToString(sha256Hash.ComputeHash(Encoding.ASCII.GetBytes("***REMOVED***"))));
