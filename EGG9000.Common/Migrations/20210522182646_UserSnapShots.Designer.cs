...
namespace DiscordCoopCodes.Migrations
{
    ...
    [Migration("20210522182646_UserSnapShots")]
    partial class UserSnapShots
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.DBUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.Demerit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.Donation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.Event", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.EventCustomization", b =>
                {
                    b.Property<string>("Type")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.GlobalLeaderboardCoop", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.GlobalLeaderboardUser", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.Guild", b =>
                {
                    ...
                    b.Property<decimal?>("DemeritLogChannel")
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.GuildContract", b =>
                {
                    b.Property<string>("ContractID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.Merit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.UserSnapShot", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DiscordCoopCodes.Database.Entities.Demerit", b =>
                {
                    b.HasOne("DiscordCoopCodes.Database.Entities.DBUser", "AdminUser")
                        .WithMany("DemeritsGiven")
                        .HasForeignKey("AdminUserId")
                        .IsRequired();

                    b.HasOne("DiscordCoopCodes.Database.Entities.DBUser", "User")
                        .WithMany("Demerits")
