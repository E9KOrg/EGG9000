    ...
    public class EggIncArtifacts {
        ...
        public static List<EggIncArtifact> GetArtifactsDB() {
            return new List<EggIncArtifact> {
                ...
                new EggIncArtifact { Name = 4, Artifact = "Beak of Midas", Boost = EggIncBoostTypeEnum.DroneRewards, //done
                    L0R0 = 1.2,
                    L1R0 = 1.5,
                    L2R0 = 2, L2R1 = 3,
                    L3R0 = 6,L3R1 = 11, L3R3 = 9999
                },
                new EggIncArtifact { Name = 10, Artifact = "Book of Basan", Boost = EggIncBoostTypeEnum.EggsOfProphecyEffect, //done
                    L0R0 = 1.0025,
                    L1R0 = 1.005,
                    L2R0 = 1.0075,      L2R2 = 1.008,
                    L3R0 = 1.01,        L3R2 = 1.1, L3R3 = 1.2
                },
                new EggIncArtifact { Name = 22, Artifact = "Carved Rainstick", Boost = EggIncBoostTypeEnum.CashGiftChance, //done
                    L0R0 = 1.2,
                    L1R0 = 1.5,
                    L2R2 = 2,
                ...
                new EggIncArtifact { Name = 40, Artifact = "Clarity Stone", Boost = EggIncBoostTypeEnum.HostArtifactsOnElightenment, //done
                    L0R0 = 0.25,
                    L1R0 = 0.50,
                    L2R0 = 1
                },
                new EggIncArtifact { Name = 6, Artifact = "Demeters Necklace", Boost = EggIncBoostTypeEnum.EggValue, //done
                    L0R0 = 1.1,
                    L1R0 = 1.25, L1R1 = 1.35,
                    L2R0 = 1.5, L2R1 = 1.6, L2R2 = 1.75,
                    L3R0 = 2, L3R1 = 2.25, L3R2 = 2.5, L3R3 = 3
                },
                new EggIncArtifact { Name = 28, Artifact = "Dilithium Monocle", Boost = EggIncBoostTypeEnum.BoostEffectiveness, //done
                    L0R0 = 1.05,
                    L1R0 = 1.1,
                    L2R0 = 1.14,
                    L3R0 = 1.2, L3R2 = 1.25, L3R3 = 1.3
                },
                new EggIncArtifact { Name = 31, Artifact = "Dilithium Stone", Boost = EggIncBoostTypeEnum.BoostDuration,  //done
                    L0R0 = 1.03,
                    L1R0 = 1.06,
                    L2R0 = 1.08
                },
                new EggIncArtifact { Name = 8, Artifact = "Gusset", Boost = EggIncBoostTypeEnum.HabCapacity, //done
                    L0R0 = 1.05,
                    L1R0 = 1.1,             L1R2 = 1.12,
                    L2R0 = 1.14, L2R1 = 1.15,
                    L3R0 = 1.2, L3R2 = 1.22, L3R3 = 1.25
                },
                new EggIncArtifact { Name = 27, Artifact = "Interstellar Compass", Boost = EggIncBoostTypeEnum.EggShippingRate, //done
                    L0R0 = 1.05,
                    L1R0 = 1.1,
                    L2R0 = 1.2, L2R1 = 1.22,
                    L3R0 = 1.3, L3R1 = 1.35, L3R2 = 1.4, L3R3 = 1.5
                },
                new EggIncArtifact { Name = 38, Artifact = "Life Stone", Boost = EggIncBoostTypeEnum.InternalHatchery, //done
                    L0R0 = 1.02,
                    L1R0 = 1.03,
                    L2R0 = 1.04
                },
                new EggIncArtifact { Name = 5, Artifact = "Light of Eggendil", Boost = EggIncBoostTypeEnum.EnlightenmentEggValue, //done
                    L0R0 = 1.5,
                    L1R0 = 2, L1R1 = 2.2,
                    L2R0 = 10, L2R1 = 15,
                    L3R0 = 101, L3R2 = 151, L3R3 = 251
                },
                new EggIncArtifact { Name = 33, Artifact = "Lunar Stone", Boost = EggIncBoostTypeEnum.AwayEarnings, //done
                    L0R0 = 1.2,
                    L1R0 = 1.3,
                    L2R0 = 1.4
                },
                new EggIncArtifact { Name = 0, Artifact = "Lunar Totem", Boost = EggIncBoostTypeEnum.AwayEarnings, //done
                    L0R0 = 1.5,
                    L1R0 = 2, L1R1 = 2.5,
                    L2R0 = 4, L2R1 = 5,
                    L3R0 = 6, L3R1 = 8, L3R2 = 10
                },
                new EggIncArtifact { Name = 30, Artifact = "Mercury's Lens", Boost = EggIncBoostTypeEnum.FarmValue, //done
                    L0R0 = 1.1,
                    L1R0 = 1.2, L1R1 = 1.22,
                    L2R0 = 1.5, L2R1 = 1.55,
                    L3R0 = 2, L3R1 = 2.25, L3R2 = 2.5, L3R3 = 3
                },
                new EggIncArtifact { Name = 3, Artifact = "Neodymium Medallion", Boost = EggIncBoostTypeEnum.DroneFrequency, //done
                    L0R0 = 1.1,
                    L1R0 = 1.25, L1R1 = 1.3,
                    L2R0 = 1.5, L2R2 = 1.6,
                    L3R0 = 2, L3R1  =2.1, L3R2 = 2.2, L3R3 = 2.29
                },
                new EggIncArtifact { Name = 11, Artifact = "Phoenix Feather", Boost = EggIncBoostTypeEnum.SoulEggCollectionRate, //done
                    L0R0 = 1.25,
                    L1R0 = 2,
                    L2R0 = 5, L2R1 = 6,
                    L3R0 = 10,
                ...
                new EggIncArtifact { Name = 39, Artifact = "Prophecy Stone", Boost = EggIncBoostTypeEnum.EggsOfProphecyEffect, //done
                    L0R0 = 1.0005,
                    L1R0 = 1.001,
                    L2R0 = 1.0015
                },
                new EggIncArtifact { Name = 23, Artifact = "Puzzle Cube", Boost = EggIncBoostTypeEnum.ResearchCost, //done
                    L0R0 = 1.05,
                    L1R0 = 1.1,              L1R2 = 1.15,
                    L2R0 = 1.2, L2R1 = 1.22,
                    L3R0 = 1.5, L3R1 = 1.53, L3R2 = 1.55, L3R3 = 1.6
                },
                new EggIncArtifact { Name = 24, Artifact = "Quantum Metronome", Boost = EggIncBoostTypeEnum.EggLayingRate, //done
                    L0R0 = 1.05,
                    L1R0 = 1.1, L1R1 = 1.12,
                    L2R0 = 1.14999, L2R1 = 1.17, L2R2 = 1.2,
                    L3R0 = 1.25, L3R1 = 1.27, L3R2 = 1.3, L3R3 = 1.35
                },
                new EggIncArtifact { Name = 36, Artifact = "Quantum Stone", Boost = EggIncBoostTypeEnum.EggShippingRate, //done
                    L0R0 = 1.02,
                    L1R0 = 1.04,
                    L2R0 = 1.05
                },
                new EggIncArtifact { Name = 32, Artifact = "Shell Stone", Boost = EggIncBoostTypeEnum.EggValue, //done
                    L0R0 = 1.05,
                    L1R0 = 1.08,
                    L2R0 = 1.10
                },
                new EggIncArtifact { Name = 25, Artifact = "Ship in a Bottle", Boost = EggIncBoostTypeEnum.CoopMembersEarnings, //done
                    L0R0 = 1.2,
                    L1R0 = 1.3,
                    L2R0 = 1.5, L2R1 = 1.6,
                    L3R0 = 1.7, L3R1 = 1.8, L3R2 = 1.9, L3R3 = 2
                },
                new EggIncArtifact { Name = 34, Artifact = "Soul Stone", Boost = EggIncBoostTypeEnum.SoulEggBonus, //done
                    L0R0 = 1.05,
                    L1R0 = 1.1,
                    L2R0 = 1.25
                },
                new EggIncArtifact { Name = 26, Artifact = "Tachyon Deflector", Boost = EggIncBoostTypeEnum.CoopMembersEggLayingRates, //done
                 L0R0 = 1.05,
                 L1R0 = 1.08,
                 L2R0 = 1.12, L2R1 = 1.12,
                 L3R0 = 1.14, L3R1 = 1.17, L3R2 = 1.19, L3R3 = 1.2
                },
                new EggIncArtifact { Name = 1, Artifact = "Tachyon Stone", Boost = EggIncBoostTypeEnum.EggLayingRate, //done
                    L0R0 = 1.02,
                    L1R0 = 1.04,
                    L2R0 = 1.05
                },
                ...
                new EggIncArtifact { Name = 29, Artifact = "Titanium Actuator", Boost = EggIncBoostTypeEnum.HoldToHatch, Additive = true, //done
                    L0R0 = 1,
                    L1R0 = 4,
                    L2R0 = 6, L2R1 = 7,
                    L3R0 = 10,          L3R2 = 12, L3R3 = 15
                },
                new EggIncArtifact { Name = 12, Artifact = "Tungsten Ankh", Boost = EggIncBoostTypeEnum.EggValue, //done
                    L0R0 = 1.1,
                    L1R0 = 1.25, L1R1 = 1.28,
                    L2R0 = 1.5, L2R1 = 1.75, L2R3 = 2,
                    L3R0 = 2, L3R1 = 2.25,              L3R3 = 2.5
                },
                new EggIncArtifact { Name = 7, Artifact = "Vial of Martian Dust", Boost = EggIncBoostTypeEnum.MaxRunningChickenBonus, Additive = true, //done
                    L0R0 = 10,
                    L1R0 = 50, L1R1 = 60,
                    L2R0 = 100,             L2R2 = 150,
