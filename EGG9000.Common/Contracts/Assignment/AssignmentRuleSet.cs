...
namespace EGG9000.Common.Contracts.Assignment {
    public static class AssignmentRuleSet {
        ...
        public static readonly IReadOnlyList<IAssignmentRule> Gate = [
        ...
        public static readonly IReadOnlyList<IAssignmentRule> Force = [
        ...
        public static readonly IReadOnlyList<IAssignmentRule> Include = [
