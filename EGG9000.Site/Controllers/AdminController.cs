...
namespace EGG9000.Site.Controllers {
    ...
    public partial class AdminController(UserManager<ApplicationUser> userManager, DiscordSocketClient discord,
        ...
        public async Task<IActionResult> Slackers() {
            ...
            var slackers = await _db.DBUsers.Include(x => x.UserCoopXrefs).Where(x => x.GuildId == user.GuildId && x.UserCoopXrefs.Any(y => y.RunningScore < scoreThreshold)).Select(x => new Admin_Slacker {
