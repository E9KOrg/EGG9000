...
namespace EGG9000.Bot.Services {
    ...
    public class SlashCommandService : IHostedService {
        ...
        public SlashCommandService(IConfiguration Configuration, DiscordSocketClient discord, APILink apilink, Words words, Bugsnag.IClient bugsnag, ContractUpdater contractUpdater, CoopStatusUpdater coopStatusUpdater) {
